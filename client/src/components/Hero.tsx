            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row">
                  <span className="inline-flex items-center px-3 sm:px-4 py-2 sm:py-[10px] bg-white/20 border border-white/30 sm:border-r-0 rounded-lg sm:rounded-l-lg sm:rounded-r-none text-xs sm:text-sm whitespace-nowrap">
                    localqr.earth/
                  </span>
                  <Input
                    type="text"
                    ...
                    className="flex-1 mt-2 sm:mt-0 rounded-lg sm:rounded-l-none sm:rounded-r-lg placeholder-gray-400 py-2 sm:py-[10px] px-3 h-auto input-animated text-gray-900 border-gray-300 text-sm sm:text-base"
              ...
              >
                <Button
                  ...
                  size="lg"
                  className="w-full sm:w-auto lg:w-auto font-semibold text-base sm:text-lg btn-animated ripple-effect text-white hover:opacity-90 px-6 sm:px-8 py-3 sm:py-4"
